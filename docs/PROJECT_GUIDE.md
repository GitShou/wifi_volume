...
13. [リソース層](#sec-13)
14. [その他の XML](#sec-14)
15. [このプロジェクトの設計上の特徴](#sec-15)
16. [学習者向けのおすすめ読書順](#sec-16)
17. [このプロジェクトで学べる Android のポイント](#sec-17)
18. [現時点の注意点](#sec-18)
19. [最後に: このプロジェクトを一言で言うと](#sec-19)
...
### 15-1. ViewModel を使わず Activity 中心
...
### 15-3. ルール判定を `RuleEvaluator` に寄せている
